  ...
  return (
    <div id="home" className="relative h-screen flex items-center justify-center text-white overflow-hidden flex-col ">
      ...
      <div className="absolute left-6 top-1/2 -translate-y-1/2 flex flex-col space-y-12 z-20 ">
        ...
        <a
          href="https://www.instagram.com/phuyalsaksham/"
          target="_blank"
          rel="noopener noreferrer"
          className="p-3 rounded-full border-2 border-neonGreen shadow-[0_0_7px_#39ff14,0_0_30px_#39ff14,0_0_45px_#39ff14] hover:scale-110 transition-transform"
        >
      ...
      <div className="relative z-10 flex flex-col items-center">
        <Image
          ...
          width={220}
          height={190}
          className="rounded-full border-[#0c0c48aa] shadow-[0_0_10px_rgba(255,0,0,0.7),0_0_20px_rgba(255,0,0,0.5),0_0_30px_rgba(255,0,0,0.3)] animate-[pulseRed_2s_ease-in-out_infinite]"
        />

        <h1 className="text-3xl mt-6 text-center font-bold tracking-wide">
          Full-Stack Developer passionate about building <br /> dynamic and user-friendly applications.
        </h1>

        <h2 className="mt-5 text-lg text-center font-medium flex items-center">
          Hi! I&apos;m Saksham - A passionate{" "}
